...
<div class = "card mt-4">
    ...
    <div class="mb-3">
        ...
        <textarea name="description" class="form-control" row="4" id="mySummernote" >{!! $post->description !!}</textarea>
    </div>
    ...
    <div class="mb-3">
        ...
        <textarea name="meta_description" class="form-control" row="3">{!!$post->meta_description!!}</textarea>
    </div>

    <div class="mb-3">
        <label for="">meta keyword</label>
        <textarea name="meta_keyword" class="form-control" row="3">{!!$post->meta_keyword!!}</textarea>
    </div>
